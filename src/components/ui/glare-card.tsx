...
export const GlareCard = ({
    ...
    return (
        <div
            ...
            // Removed fixed w-[320px] and aspect-ratio – fills parent instead
        ...
        >
            <div className="h-full grid will-change-transform origin-center transition-transform duration-[var(--duration)] ease-[var(--easing)] [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] rounded-[var(--radius)] hover:[--opacity:0.2] hover:[--duration:200ms] hover:[--easing:linear] overflow-hidden">

                {/* Content layer – pointer events ON so buttons/links work */}
                ...
                {/* Glare overlay – pointer events OFF */}
                ...
                {/* Rainbow foil overlay – pointer events OFF */}
                <div
